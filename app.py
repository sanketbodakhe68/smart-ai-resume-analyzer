...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/sanketbodakhe68/smart-ai-resume-analyzer' target='_blank' style='text-decoration: none;'>
    ...
    def render_login_page(self):
        ...
        if st.session_state.get('is_admin', False):
            st.success(f"Already logged in as: {st.session_state.get('current_admin_email')}")
        ...
        with st.form("admin_login_form"):
            admin_email_input = st.text_input("Email", key="login_page_email")
            admin_password = st.text_input("Password", type="password", key="login_page_password")
            ...
            if submitted:
                try:
                    if verify_admin(admin_email_input.strip(), admin_password.strip()):
